      ...
      <div style={pageShellStyle}>
        ...
        <section style={{ ...cardStyle, padding: "1.25rem 1.15rem 1.35rem", display: "grid", gap: 14 }}>
          <div style={{ display: "grid", gap: 8 }}>
            ...
            >
              Civilian Exchange Board
            </span>
            <h1 style={{ margin: 0 }}>Marketplace</h1>
            <p style={{ margin: 0, maxWidth: 640, color: "#cbd5e1", lineHeight: 1.65 }}>
              This app shell is live and ready for us to build out listings, item detail pages, seller tools, and the rest of the marketplace flow.
            </p>
          </div>
          ...
          >
            {[
              ...
              "Seller post creation flow",
              "Item detail pages and photos",
              "Messaging and transaction status",
            ].map((item) => (
              <div
                key={item}
                style={{
